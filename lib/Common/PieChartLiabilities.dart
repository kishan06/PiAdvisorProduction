...
class PieChartLiabilites extends StatefulWidget {
  const PieChartLiabilites({Key? key}) : super(key: key);

  @override
  State<StatefulWidget> createState() => PieChartLiabilitesState();
}

class PieChartLiabilitesState extends State {
  int touchedIndex = -1;
