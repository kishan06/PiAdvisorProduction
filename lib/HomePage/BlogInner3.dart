...
class BlogInner3 extends StatefulWidget {
  BlogInner3({
    Key? key,
  ...
  @override
  State<BlogInner3> createState() => _BlogInner3State();
  int allBlogIndex;
}

class _BlogInner3State extends State<BlogInner3> {
    RegExp exp = RegExp(
        r"<[^>]*>",
        multiLine: true,
        caseSensitive: true
      ...
      body: SingleChildScrollView(
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              Text(
                blogs.blog2![widget.allBlogIndex].title!,
              ...
              Text(
                blogs.blog2![widget.allBlogIndex].publishDate!,
                style: TextStyle(
              ...
              SizedBox(
                ...
                child: Padding(
                  ...
                  child: Image.network(
                    ApiConstant.piImages + blogs.blog2![widget.allBlogIndex].innerBlogImage!,
                    width: 400,
                    height: 283,
                    fit: BoxFit.cover,
                  ),
              ...
              Container(
                ...
                child: Padding(
                  padding: const EdgeInsets.all(10),
                  child: Text(
                    blogs.blog2![widget.allBlogIndex].discription!.replaceAll(exp, ''),
                    style: TextStyle(
