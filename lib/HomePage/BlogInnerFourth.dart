...
class BlogInnerFourth extends StatefulWidget {
  BlogInnerFourth({
    Key? key,
  ...
  @override
  State<BlogInnerFourth> createState() => _BlogInnerFourthState();
  int allBlogIndex;
}

class _BlogInnerFourthState extends State<BlogInnerFourth> {
    RegExp exp = RegExp(
        r"<[^>]*>",
        multiLine: true,
        caseSensitive: true
      ...
      body: SingleChildScrollView(
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              Text(
                blogs.blog3![widget.allBlogIndex].title!,
              ...
              Text(
                blogs.blog3![widget.allBlogIndex].publishDate!,
                style: TextStyle(
              ...
              SizedBox(
                ...
                child: Padding(
                  ...
                  child: Image.network(
                    ApiConstant.piImages + blogs.blog3![widget.allBlogIndex].innerBlogImage!,
                    width: 400,
                    height: 283,
                    fit: BoxFit.cover,
                  ),
              ...
              Container(
                ...
                child: Padding(
                  padding: const EdgeInsets.all(10),
                  child: Text(
                    blogs.blog3![widget.allBlogIndex].discription!.replaceAll(exp, ''),
                    style: TextStyle(
