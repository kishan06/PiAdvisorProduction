...
class SearchedStockGraph extends StatefulWidget {
  SearchedStockGraph({
    Key? key,
    this.fincode,
    this.mCap,
  ...
  bool? showbuysell;
  @override
  State<SearchedStockGraph> createState() => _SearchedStockGraphState();
}

class _SearchedStockGraphState extends State<SearchedStockGraph> {
              ...
              switch (snapshot.connectionState) {
                ...
                default:
                  if (snapshot.hasError) {
                    ...
                    return snapshot.data!.table == null ||
                            snapshot.data!.table!.isEmpty
      ...
      child: Column(
        ...
        children: [
                                ...
                                ? SizedBox(
                                    ...
                                    child: ElevatedButton(
                                      onPressed: () {
                                        ...
                                        Timer.periodic(Duration(seconds: 8),
                                            (timer) {
                                          tradeBtnState(
                                            () {
            ...
            children: [
              Column(
                ...
                children: [
                  ...
                  Text(priceData.table!.last.low ?? "NA"),
                  SizedBox(
                    height: 5,
                  ),
                ],
              ...
              Column(
                ...
                children: [
                  Text("Todays High"),
                  Text(priceData.table!.last.high ?? "NA"),
                  SizedBox(
                    height: 5,
                  ),
                ],
          ...
          LinearPercentIndicator(
            lineHeight: 2,
            percent: double.parse(priceData.table!.last.low ?? "0.0") /
                double.parse(priceData.table!.last.high ?? "0.0"),
            ...
            children: [
              Column(
                ...
                children: [
                  ...
                  Text(priceData.table!.last.open ?? "NA"),
                ],
              ),
              Column(
                crossAxisAlignment: CrossAxisAlignment.start,
              ...
              Column(
                ...
                children: [
                  ...
                  Text(priceData.table!.last.volume ?? "NA"),
                ],
              )
            ],
          ),
