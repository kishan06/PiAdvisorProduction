...
class LoadingPageKYC extends StatefulWidget {
  const LoadingPageKYC({Key? key}) : super(key: key);

  @override
  State<LoadingPageKYC> createState() => _LoadingPageKYCState();
}

class _LoadingPageKYCState extends State<LoadingPageKYC> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      body: FutureBuilder(
        future: KYCDigilocker().checkKycDetails(),
