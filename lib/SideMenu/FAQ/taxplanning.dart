...
class planningFaq extends StatefulWidget {
  planningFaq({Key? key, required this.faq}) : super(key: key);

  @override
  State<planningFaq> createState() => _planningFaqState();
  List<Cat3> faq = [];
}

class _planningFaqState extends State<planningFaq> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: const CustomAppBar(titleTxt: "Tax Planning", bottomtext: false),
