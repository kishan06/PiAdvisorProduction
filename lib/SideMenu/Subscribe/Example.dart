...
class DemoChoosePlanScreen5 extends StatefulWidget {
  @override
  DemoChoosePlanScreen5State createState() => DemoChoosePlanScreen5State();
}

class DemoChoosePlanScreen5State extends State<DemoChoosePlanScreen5> {
  int selectIndex = 0;
            ...
            return AnimatedContainer(
              ...
              decoration: boxDecorationDefault(
                color: selectIndex == index
                    ? appStore.appColorPrimary.withOpacity(0.3)
                    : context.cardColor,
