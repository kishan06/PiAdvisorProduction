...
class SubcriptionDetailsForThirdCard extends StatefulWidget {
  const SubcriptionDetailsForThirdCard({Key? key}) : super(key: key);

  @override
  State<SubcriptionDetailsForThirdCard> createState() => _SubcriptionDetailsForThirdCardState();
}

class _SubcriptionDetailsForThirdCardState extends State<SubcriptionDetailsForThirdCard> {
  @override
  Widget build(BuildContext context) {
    print("reached 3rd card");
    return Scaffold(
                  ...
                  SizedBox(
                    ...
                    child: Text.rich(
                        const TextSpan(children: [
                          TextSpan(
                              text:
                                  "One-time upfront fee of ₹ 999/- only"),
                          // TextSpan(
                          //     text: "market value",
                          //     style: TextStyle(
              ...
              Row(
                ...
                children: [
                  ...
                  SizedBox(
                    width: MediaQuery.of(context).size.width * 0.6,
                    child: Text(
                      "Plus 1% of Assets Under Advice (AUA) per annum",
                      style: blackStyle(context).copyWith(
                          fontSize: 12.sm,
                          color: Colors.black,
                          fontWeight: FontWeight.normal),
